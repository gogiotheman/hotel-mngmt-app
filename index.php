        ...
        <div class="auth_container">
            ...
            <div id="Log_in">
                ...
                if (isset($_POST['user_login_submit'])) {
                    ...
                    $sql = "SELECT * FROM tblclienti WHERE emailClient = '$Email' AND parolaClient = BINARY'$Password'";
                ...
                <?php              
                    if (isset($_POST['Emp_login_submit'])) {
                        ...
                        $sql = "SELECT * FROM tblsalariati WHERE emailSalariat = '$Email' AND parolaSalariat = BINARY'$Password'";
                        $result = mysqli_query($hotelConn, $sql);
                ...
                if (isset($_POST['user_signup_submit'])) {
                    ...
                    if($Name == "" || $Username == "" || $Email == "" || $Phone == "" || $Password == ""){
                        ...
                        if ($Password == $CPassword) {
                            ...
                            $sql = "SELECT * FROM tblclienti WHERE emailClient = '$Email'";
                            $result = mysqli_query($hotelConn, $sql);
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                $sql = "INSERT INTO tblclienti (numeClient, usernameClient, emailClient, nrTelClient, parolaClient) VALUES ('$Name', '$Username', '$Email', '$Phone', '$Password')";
                                $result = mysqli_query($hotelConn, $sql);
